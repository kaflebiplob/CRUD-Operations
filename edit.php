        ...
        <form action="process.php" method="post">
            ...
            <div class="form-element my-4">
                <select name="type" class="form-control" id="" value="<?php echo $row["type"]; ?>">
                    ...
                    <option value="" <?php if ($row["type"] == "Adventure") {
                                            echo "selected";
                                        } ?>>Adventure</option>
                    <option value="" <?php if ($row["type"] == "ScFi") {
                                            echo "selected";
                                        } ?>>ScFi</option>
                    <option value="" <?php if ($row["type"] == "Thriller") {
                                            echo "selected";
                                        } ?>>Thriller</option>
                    <option value="" <?php if ($row["type"] == "Horror") {
                                            echo "selected";
                                        } ?>>Horror</option>
                    <option value="" <?php if ($row["type"] == "Love Story") {
                                            echo "selected";
                                        } ?>>Love Story</option>
